...
using SimpraoSistemas.Context;
using SimpraoSistemas.Models;

namespace SimpraoSistemas.Controllers
{
    public class LoginController : Controller
    {
        private readonly SimpraoContext _context;

        public LoginController(SimpraoContext context)
        {
            _context = context;
        }
